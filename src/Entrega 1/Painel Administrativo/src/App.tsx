...
import { limparSessao, obterToken, obterUsuario, type UsuarioAutenticado } from './services/api';
...
function AdminShell({
  ...
  return (
    <div className={`flex h-screen overflow-hidden ${darkMode ? 'dark' : ''}`}>
      {/* Mobile overlay */}
      <div
        className={`fixed inset-0 z-30 bg-black/50 lg:hidden transition-opacity ${!collapsed ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}
